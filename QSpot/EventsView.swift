        ...
        ZStack {
            ...
            ScrollView(showsIndicators: false) {
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    }.padding(22).frame(maxWidth: .infinity, alignment: .leading).background(LinearGradient(colors: [Color.appPink, Color.appPurple], startPoint: .topLeading, endPoint: .bottomTrailing), in: RoundedRectangle(cornerRadius: 30))
